...
const HomeGridLink = (props: Props) => {
  return (
    <div className='flex justify-between w-52'>
      <Link to={props.link} target={props.redirect ? '_blank' : undefined} className='text-neutral-500 flex items-start gap-1 w-36 -mx-3 px-3 rounded hover:bg-neutral-800'>
